...
const UpdateScript = () => {
  ...
  const handleExecutePlaybook = async () => {
    try {
      const res = await axios.post('/api/apache/executeCommand');
    ...
    <Row>
      ...
      <Col md={10}>
        <View style={{ display: 'block', justifyContent: 'center', alignItems: 'center', height: '100%', marginTop: '30%', marginLeft: '15%' }}>
          ...
          <Text style={{ textAlign: 'center', marginBottom: 20, color: '#3c79f2' , fontFamily: 'Gill Sans', fontSize: 36, fontWeight: 600, marginBottom: '60px'}}>Install Apache Web Server</Text>
            <Form>
              <Form.Item>
