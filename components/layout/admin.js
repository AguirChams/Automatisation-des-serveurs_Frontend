...
const AdminUsers = () => {
  ...
  const handleEdit = record => {
    ...
    message.success('acount details edited successfully')
  };
  ...
  const handleDelete = record => {
    fetch(`/api/users/${record._id}`, {
      ...
      .then(() => {
        ...
        message.success('administrator account deleted successfully')
      })
      .catch(err => console.log(err));
  };
  ...
  <Text style={{ textAlign: 'center', color: '#3c79f2' , fontFamily: 'Gill Sans', fontSize: 36, fontWeight: 600, marginBottom: '60px'}}>Administrators List</Text>
